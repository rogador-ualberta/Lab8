...
public class CustomList extends ArrayAdapter<City> {
     ...
     * @param city
     * This is the city being checked whether or not it belongs in the list
     * @return
     * True if it belongs in the list, false if it doesn't
     */
     ...
     * @param city
     * This is the city being removed from the list
     */
